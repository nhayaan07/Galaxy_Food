...
<div className='flex flex-col space-y-8 items-start h-full justify-start p-5 sm:items-center md:justify-center max-md:pt-[60%]'>
  ...
  <p data-aos="zoom-in" data-aos-delay="500" className='text-white text-2xl'>শহরের সেরা কাচ্চির স্বাদ পেতে আপনাকে আসতে হবে গ্যালাক্সি ফুডে</p>
  <a href="#menu"><button data-aos="fade" data-aos-delay="700" className='btn-default bg-[--secondary-color] font-semibold'>আমাদের মেনু দেখুন</button></a>
</div>
